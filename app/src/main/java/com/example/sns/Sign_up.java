...
public class Sign_up extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (firebaseAuth.getCurrentUser() != null) {
            ...
            startActivity(new Intent(getApplicationContext(), Privacy.class)); //추가해 줄 ProfileActivity
        }
        //initializing views
    ...
    private void registerUser() {
        ...
        String passwordCheck = editTextCheckPassword.getText().toString().trim();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Sign_up.this, "등록 에러!", Toast.LENGTH_SHORT).show();
                        }
